...
function integral(f::F, rope::Meshes.Rope, settings::HAdaptiveCubature) where {F<:Function}
...
function integral(f::F, rope::Meshes.Rope, settings::I) where {F<:Function,I<:IntegrationAlgorithm}
  # Convert the Rope into Segments, sum the integrals of those 
