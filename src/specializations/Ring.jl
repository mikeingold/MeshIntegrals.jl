...
function integral(f::F, ring::Meshes.Ring, settings::HAdaptiveCubature) where {F<:Function}
...
function integral(f::F, ring::Meshes.Ring, settings::I) where {F<:Function,I<:IntegrationAlgorithm}
  # Convert the Ring into Segments, sum the integrals of those 
